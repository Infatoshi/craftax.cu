// Optimized variant header for craftax.cu kernels.
// Differences vs Oracle:
//   - achievements stored as uint32_t bitmask (saves 18 bytes, enables popc diff)
//   - No semantic changes; step/obs outputs must match Oracle bitwise.
#pragma once
#include <cstdint>
...
struct __align__(16) EnvState {
    ...
    float light_level;
    uint32_t achievements;  // OPT: bitmask instead of bool[22]
    int32_t timestep;
