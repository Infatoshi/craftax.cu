...
public:
    ...
    CraftaxEnvOpt3(int num_envs_, uint64_t seed_)
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    pybind11::class_<CraftaxEnvOpt3>(m, "CraftaxEnvOpt3")
        .def(pybind11::init<int, uint64_t>(), pybind11::arg("num_envs") = 4096, pybind11::arg("seed") = 42)
        .def("reset", &CraftaxEnvOpt3::reset)
        .def("step", &CraftaxEnvOpt3::step)
        .def("get_obs_dim", &CraftaxEnvOpt3::get_obs_dim)
        .def("get_num_actions", &CraftaxEnvOpt3::get_num_actions)
        .def("get_num_envs", &CraftaxEnvOpt3::get_num_envs)
        .def("get_state_size", &CraftaxEnvOpt3::get_state_size)
        .def_readonly("obs", &CraftaxEnvOpt3::obs)
        .def_readonly("rewards", &CraftaxEnvOpt3::rewards)
        .def_readonly("dones", &CraftaxEnvOpt3::dones);
}
